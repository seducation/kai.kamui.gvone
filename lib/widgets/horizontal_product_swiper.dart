    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Image.network(product.imageUrl, width: 200, height: 200, fit: BoxFit.cover),
            const SizedBox(height: 20),
            Text('Product: ${product.name}', style: const TextStyle(fontSize: 24)),
            const SizedBox(height: 10),
            Text('Price: \$${product.price.toStringAsFixed(2)}', style: const TextStyle(fontSize: 20)),
          ],
        ),
      ),
    );
...
class HorizontalProductSwiper extends StatefulWidget {
  ...
  @override
  State<HorizontalProductSwiper> createState() => _HorizontalProductSwiperState();
}
